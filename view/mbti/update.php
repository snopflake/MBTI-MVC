...
<div class="container">
    ...
    <div class="form-container">
     <button class="back-button" onclick="window.location.href='?c=Mbti&m=index';">&#8592; </button>
        ...
        <form action="?c=Mbti&m=update" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($mbtis['id']); ?>">
            <input type="hidden" name="gambar_lama" value="<?php echo htmlspecialchars($mbtis['gambar']); ?>">

            <div class="form-group">
                <label for="nama">Nama</label>
                <input type="text" id="nama" name="nama" value="<?php echo htmlspecialchars($mbtis['nama']); ?>" required>
            </div>

            <div class="form-group">
                <label for="mbti">Tipe MBTI</label>
                <input type="text" id="mbti" name="mbti" value="<?php echo htmlspecialchars($mbtis['mbti']); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="motto" name="motto" rows="4"><?php echo htmlspecialchars($mbtis['motto']); ?></textarea>
            </div>
